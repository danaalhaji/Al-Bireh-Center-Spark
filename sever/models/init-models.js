...
function initModels(sequelize) {
  ...
  initial_assessment.belongsToMany(initial_assessment, { as: 'initial_assessment_user_iduser_initial_assessments', through: specializtion, foreignKey: "initial_assessment_idinitial_assessment", otherKey: "initial_assessment_user_iduser" });
  initial_assessment.belongsToMany(initial_assessment, { as: 'initial_assessment_idinitial_assessment_initial_assessments', through: specializtion, foreignKey: "initial_assessment_user_iduser", otherKey: "initial_assessment_idinitial_assessment" });
